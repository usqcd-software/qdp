...
!PCSHIFTTYPES
void QDP$PC_$ABBR_eq_s$ABBR($NC$QDPPCTYPE *__restrict__ dest, $QDPPCTYPE *src, QDP_Shift shift, QDP_ShiftDir fb, QDP_Subset subset);
void QDP$PC_$ABBR_veq_s$ABBR($NC$QDPPCTYPE *__restrict__ dest[], $QDPPCTYPE *src[], QDP_Shift shift[], QDP_ShiftDir fb[], QDP_Subset subset, int nv);
!END
